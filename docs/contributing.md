...
The View Binding contributing policies and procedures can be found in the
main View Binding documentation repository’s
[contributing page](https://github.com/zeoflow/view-binding/blob/CONTRIBUTING.md).
...
View Binding for Android has JVM tests as well as Emulator tests.
...
whitespace, View Binding uses code conventions and styles to
