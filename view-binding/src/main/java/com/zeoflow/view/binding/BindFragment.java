...
public abstract class BindFragment<T extends ViewDataBinding, S extends ViewBinding> extends Fragment implements ViewInterface<T, S>, OnViewModelInitializedCallback<S>
{
