...
public abstract class BindAppActivity<T extends ViewDataBinding, S extends ViewBinding> extends AppCompatActivity implements ViewInterface<T, S>, OnViewModelInitializedCallback<S>
{
