...
public abstract class ViewModelDialogFragment<T extends ViewDataBinding, S extends ViewBinding> extends DialogFragment implements ViewInterface<T, S>, OnViewModelInitializedCallback<S>
{
